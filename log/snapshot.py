...
parser.add_argument('-t', '--timer', type=int, default=300, dest='timer', help='default 300s')
parser.add_argument('-l', '--log', type=str, default='txt', dest='log', help='default txt')
...
def output_log_by_timer():
    ...
    while True:
        ...
        if select_type_log == 'txt':
            ...
            print("SNAPSHOT", number_count, system_data, "CPU %:",
                  system_cpu, "RAM Total:", system_ram, "IO:",
                  system_io, "Used disk:", system_disk_percent,
                  "Network:", system_net, file=log_data)
